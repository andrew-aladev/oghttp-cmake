...
const ogh_processor_state_t OGH_PROCESSOR_HEADER_NAME_ANY_INITIAL_STATE = 0;

#define ALLOWED_BYTES_LENGTH OGH_MAX_BYTE + 1

// clang-format off
const bool OGH_PROCESSOR_HEADER_NAME_ANY_ALLOWED_BYTES[ALLOWED_BYTES_LENGTH] = {
...
extern inline ogh_processor_state_t ogh_processor_header_name_any_get_next_state(
