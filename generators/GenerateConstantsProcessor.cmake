...
function (generate_constants_processor NAME DECLARATION_PATH)
  ...
  set (OUTPUT_CONSTANT_STATES            "CMAKE_CONSTANT_STATES")
  ...
  if (CMAKE_LIBXML2_WORKS)
    ...
    if (COMPILE_RESULT)
      ...
      if (RUN_RESULT EQUAL 0)
        ...
        list (GET RUN_OUTPUT 1 CONSTANT_STATES)
        set (${OUTPUT_CONSTANT_STATES} ${CONSTANT_STATES} PARENT_SCOPE)
        list (GET RUN_OUTPUT 2 MAX_STATE)
        ...
        list (GET RUN_OUTPUT 4 ALPHABET_LENGTH)
        set (${OUTPUT_ALPHABET_LENGTH} ${ALPHABET_LENGTH} PARENT_SCOPE)
        list (GET RUN_OUTPUT 5 SYMBOL_BY_BYTES)
        set (${OUTPUT_SYMBOL_BY_BYTES} ${SYMBOL_BY_BYTES} PARENT_SCOPE)
        list (GET RUN_OUTPUT 6 NEXT_STATE_BY_LAST_SYMBOLS)
        ...
        unset (${OUTPUT_CONSTANT_STATES} PARENT_SCOPE)
